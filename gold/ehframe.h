...
class Fde
{
 public:
  ...
  bool
  post_map() const
  { return this->object_ == nullptr && this->u_.from_linker.post_map; }
 ...
 private:
  // The object in which this FDE was seen.  This will be nullptr for a
  // linker generated FDE.
  Relobj* object_;
  union
  {
    // These fields are used if the FDE is from an input object (the
    // object_ field is not nullptr).
    struct
    {
...
class Cie
{
 ...
 private:
  ...
  // The object in which this CIE was first seen.  This will be nullptr
